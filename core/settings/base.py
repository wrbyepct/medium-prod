...
DJANGO_APPS = [
    ...
    "django.contrib.sites",  # new, associating objects and functionality to particular websites
]
...
CORS_URLS_REGEX = (
    r"^api/.$"  # any url request starts like this will have cors hearders added
)
